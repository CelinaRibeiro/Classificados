		...
		<div class="col-sm-9">
			...
			<table class="table table-striped">
				<tbody>
						...
						<td><a href="produto.php?id=<?php echo$anuncio['id']; ?>">
			...
			<ul class="pagination paginatios-sm justify-content-center">
					<?php for($q=1;$q<=$total_paginas;$q++): ?>
					<li class="<?php echo ($p==$q)?'active':''; ?> page-item"><a
					class="page-link" href="index.php?<?php 
					$w = $_GET;
					$w['p'] = $q;
